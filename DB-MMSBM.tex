...
In this section, we describe the intuition behind our proposed model, which we refer to as the dynamic bipartite mixed-membership stochastic blockmodel (DB-MMSBM). We then formally present the full modeling approach, and discuss a fast estimation algorithm that enables the analysis of large networks.
